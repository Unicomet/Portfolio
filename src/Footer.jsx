...
export default function Footer(){
    return (
        <footer id="footer" className="footer items-center p-4 bg-neutral text-neutral-content mt-24 px-24 ">
            ...
            <nav className="grid-flow-row md:grid-flow-col md:gap-8 md:place-self-center md:justify-self-end w-full md:w-auto">
                <p className="mt-auto mx-auto md:mx-0 text-base font-medium ">+52 56 53 48 42 66</p>
                <div className="flex flex-row justify-center items-end w-full ">
                    ...
                    <a href="https://linkedin.com/guillermart1" target="_blank">
                        <img src={logoLinkedin} alt="Linkedin profile" width="36" height="36" className="fill-current"/>
                    </a>
                </div>
            </nav>
        </footer>
