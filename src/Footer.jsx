...
export default function Footer(){
    return (
        <footer className="footer items-center p-4 bg-neutral text-neutral-content mt-24 px-24">
            ...
            <nav className="grid-flow-col gap-8 md:place-self-center md:justify-self-end">
                <p className="mt-auto text-base">+52 56 53 48 42 66</p>
                <a href="https://github.com/Unicomet" target="_blank">
                    <img src={logoGithub} alt="SVG as an image" width="36" height="36" className="fill-current"/>
                </a>
                <a href="https://github.com/Unicomet" target="_blank">
                    <img src={logoLinkedin} alt="SVG as an image" width="36" height="36" className="fill-current"/>
                </a>
