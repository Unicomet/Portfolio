...
export  default function Navbar(){
    ...
    function showMenu(){
        ...
        document.querySelector('nav').classList.remove('-left-full');
    ...
    function hideMenu(){
        ...
        document.querySelector('nav').classList.add('-left-full');
    ...
    return (
        <div className="navbar bg-primary px-6 xl:px-36">
            ...
            <div className="flex-1 justify-center md:justify-start">
                <a className="btn btn-ghost text-3xl px-0" href="https://unicomet.github.io/Portfolio/">Portfolio Guillermo M.</a>
            </div>
            <div className="flex-none">
                <nav className="menu absolute top-16 px-6 py-12 -left-full bg-primary w-full h-full md:static md:py-4 md:px-1 md:flex transition-all">
                    <ul className="flex flex-col md:flex-row justify-around items-center h-5/6 font-bold text-3xl md:text-xl">
                        <li><a href="#footer" onClick={clickMenuItem} className="text-center">Contact</a></li>
                        <li><a href={PdfResume} target="_blank" onClick={clickMenuItem} >Resume</a></li>
                        <li><a href="#experience" onClick={clickMenuItem} >Experience</a></li>
                        <li><a href="#projects" onClick={clickMenuItem} >Projects</a></li> 
                    </ul>
                </nav>
            </div>
        </div>
